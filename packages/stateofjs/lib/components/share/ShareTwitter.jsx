...
const ShareTwitter = ({ text, trackingId }, { intl }) => {
  return (
    <a
      ...
      aria-label={intl.formatMessage('share.twitter')}
    >
      ...
      <span className="sr-only">{intl.formatMessage('share.twitter')}</span>
    </a>
  );
};

ShareTwitter.contextTypes = {
  intl: intlShape,
};
